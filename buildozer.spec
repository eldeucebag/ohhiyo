...
requirements = python3,kivy==2.2.1,rns>=0.6.0,cryptography>=41.0.0,netifaces,pyserial,pyopenssl,setuptools,urllib3>=2.0.0,requests>=2.31.0,chardet>=5.0.0,idna>=3.4,certifi>=2023.0.0,libbz2,liblzma,sqlite3
